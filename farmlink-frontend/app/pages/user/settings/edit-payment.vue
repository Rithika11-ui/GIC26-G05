...
<template>
  <div class="min-h-screen flex flex-col bg-[#fbf9f6] text-on-background">
    <nav class="fixed top-0 z-50 w-full bg-[#fbf9f6] border-b border-[#efeeea]">
      <div class="max-w-[1440px] mx-auto px-4 sm:px-6 h-20 flex items-center justify-between gap-4">
        <div class="flex items-center gap-3">
          ...
          <div class="hidden sm:block">
            ...
            <p class="text-[9px] text-[#5a5b58] font-bold uppercase tracking-[0.12em]">Farm & Agri-Business Services</p>
          </div>
        </div>

        <div class="hidden lg:flex items-center gap-6">
          <a href="#" class="text-[11px] font-bold tracking-wider uppercase px-3 py-1 rounded-full bg-[#efdc97] border border-black shadow-[2px_2px_0_0_rgba(0,0,0,1)]">Home</a>
    ...
    <footer class="w-full py-12 px-8 grid grid-cols-1 md:grid-cols-2 gap-8 border-t border-[#efeeea] bg-[#efeeea] mt-auto">
      <div>
        <span class="text-lg font-black text-[#154212]">The Digital Agrarian</span>
        <p class="mt-4 text-[#5a5b58] text-sm max-w-sm">Supporting local Khmer farmers through transparent supply chains and direct-to-consumer digital infrastructure.</p>
        <p class="mt-8 text-[#5a5b58] text-xs font-label">© 2024 The Digital Agrarian. Sourced from the soil of Cambodia.</p>
      </div>
      <div class="grid grid-cols-2 gap-4">
        <div class="flex flex-col gap-3">
          <a class="text-[#5a5b58] text-sm font-body hover:text-[#006E1C] transition-colors" href="#">About Us</a>
          <a class="text-[#5a5b58] text-sm font-body hover:text-[#006E1C] transition-colors" href="#">Sustainability</a>
          <a class="text-[#5a5b58] text-sm font-body hover:text-[#006E1C] transition-colors" href="#">Shipping Policy</a>
        </div>
        <div class="flex flex-col gap-3">
          <a class="text-[#5a5b58] text-sm font-body hover:text-[#006E1C] transition-colors" href="#">Terms of Service</a>
          <a class="text-[#5a5b58] text-sm font-body hover:text-[#006E1C] transition-colors" href="#">Contact Support</a>
        </div>
      </div>
    </footer>
  </div>
